    ...
    return (
        <div className='infoBannerContainer'>
            ...
            <div className='textContainer'>
                <div className='txFlex'>
                    <div className='h1'>MODIST ONLINE FASHION SHOP</div>
                    <div className='text'>On her way she met a copy. The copy warned the Little Blind Text, that where it
